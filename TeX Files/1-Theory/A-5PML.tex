...
\begin{itemize}
    \item Elongaciones geométrias y aproximación de campo lejano considerada como válida
         \begin{align*}
...
\begin{itemize}
     \item Coeficientes de amplitud de reflexión:
        \begin{align*}
...
\end{itemize}
    ...
    \begin{alertblock}{Condiciones para una PML}
    \begin{align*}
...
\begin{frame}{\textit{Perfect Matching Layer} (PML)}
{Campos electromagnéticos}\small
\begin{itemize}
