...
\section{Resultados}
  ...
  \subsubsection{Incidencia normal}
    ...
    \begin{figure}
        ...
        \includeinkscape[pretex = \small]{1-Totally/1-Efficiencies/1-Normal-Eff}%
    \end{figure}
    \end{frame}
%
    \begin{frame}{Esfera soportada y completamente embebida}{Incidencia normal: 12.5 AuNP$@$Aire/BK7}
...
%
  \subsection{Esfera parcialmente incrustada}
    ...
    \subsubsection{Incidencia oblicua}
      ...
      \column{.55\textwidth}	\begin{figure}\centering\fontsize{4}{5}\selectfont
      ...
      \begin{frame}{Esfera parcialmete incrustada}{Incidencia después del ángulo crítico: 12.5 AuNP$@$Aire/BK7}%\fontsize{4}{5}\selectfont
  	...
  	\begin{tikzpicture}[node distance=1em and 1em,font=\small]
        \path (0,0) node [flowbox] (Sus) {\fbtitle{\ding{172} Efecto del sustrato}\vphantom{yÖ}
	    \nodepart{two}
	    Anisotropía:\\
        ...
        \node[flowbox, right = of Sus] (Ilu) {\fbtitle{\ding{173} Efecto de la iluminación}\vphantom{yÖ}
        \nodepart{two}
        ...
        \node[flowbox, right = of Ilu] (Inc) {\fbtitle{\ding{174} Efecto de la incrustación}\vphantom{yÖ}
        \nodepart{two}
         \begin{minipage}{.3\textwidth}
          \begin{itemize}
            \item Corrimiento al rojo (LSPR)
            \item Aumento de la extinsión
            \item Pol. \textit{s}:
            \begin{itemize}
