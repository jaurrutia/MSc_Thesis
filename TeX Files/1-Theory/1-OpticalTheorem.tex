...
% --------------------- index entries------------------------------------
\index{Faraday-Lenz!Law}%
\index{Law!Faraday-Lenz}
\index{Maxwell Equations|seealso{Faraday-Lenz}}%
% ------------------ eq:AvePoyntingISca ---------------------------------
\begin{equation}
...
%
\noindent
where $\dd{\Omega}$ is the solid angle differential.
